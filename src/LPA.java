...
public class LPA {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        for( ; times<max_times ; times++ ){
            ...
            FileInputFormat.addInputPath(job, new Path("/home/kexin/IdeaProjects/jinyong/output/readOutput"));
            FileOutputFormat.setOutputPath(job, new Path("/home/kexin/IdeaProjects/jinyong/output/RawTag" + times));
    ...
    public static class LPAMapper extends Mapper<Object, Text, Text, Text> {
        ...
        public void setup(Context context) throws IOException{
            ...
            Scanner open_file = new Scanner(hdfs.open(new Path("/home/kexin/IdeaProjects/jinyong/input/RawTagInput/RawTag.txt")),"UTF-8");
        ...
        public void cleanup(Context context) throws IOException{
            hdfs.delete(new Path("/home/kexin/IdeaProjects/jinyong/input/RawTagInput/RawTag.txt"));
			//先清除原来文件中的信息
            FSDataOutputStream out_put = hdfs.create(new Path("/home/kexin/IdeaProjects/jinyong/input/RawTagInput/RawTag.txt"));
